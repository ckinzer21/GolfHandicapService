    ...
    public class ScheduleTests
    {
        ...
        private List<MatchSchedule> MatchSchedulesBlindData()
        {
            var matches = new[]
            {
                ...
                new MatchSchedule { MatchScheduleId = 4,Week = 1, Date = DateTime.Today, Blind = true},
                ...
                new MatchSchedule { MatchScheduleId = 8,Week = 2, Date = DateTime.Today, Blind = true},
                ...
                new MatchSchedule { MatchScheduleId = 12,Week = 3, Date = DateTime.Today, Blind = true},
                ...
                new MatchSchedule { MatchScheduleId = 16,Week = 4, Date = DateTime.Today, Blind = true},
                ...
                new MatchSchedule { MatchScheduleId = 20,Week = 5, Date = DateTime.Today, Blind = true},
            };
